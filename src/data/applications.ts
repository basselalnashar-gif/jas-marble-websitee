...
export const applications: Application[] = [
  ...
  },
  {
    ...
    images: [
      ...
      { src: "/images/applications/furniture/fn-17.jpg", alt: "Travertine dining table with raw-edge top on a rectangular pedestal base" },
      { src: "/images/applications/furniture/fn-18.jpg", alt: "Marble-clad floating shelving unit with backlit display shelves" },
      { src: "/images/applications/furniture/fn-19.jpg", alt: "Travertine side table with raw-edge top on a fluted pedestal base" },
      { src: "/images/applications/furniture/fn-20.jpg", alt: "Black and green marble console table with tapered conical legs" },
      { src: "/images/applications/furniture/fn-21.jpg", alt: "Green marble console table with rectangular block legs" },
      { src: "/images/applications/furniture/fn-22.jpg", alt: "Travertine console table with an oval top and cylindrical legs" },
      { src: "/images/applications/furniture/fn-23.jpg", alt: "Burgundy marble rounded bench with dramatic white veining" },
      { src: "/images/applications/furniture/fn-24.jpg", alt: "Sculptural travertine bench with an angular cut-out base" },
      { src: "/images/applications/furniture/fn-25.jpg", alt: "Set of green marble pedestal side tables and a tall plinth" },
      { src: "/images/applications/furniture/fn-26.jpg", alt: "Dark grey book-matched marble bench with a dramatic diagonal seam" },
